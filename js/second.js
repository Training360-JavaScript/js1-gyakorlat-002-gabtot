...
const checker = ( array, value ) => ({
                        ...
                        index: array.findIndex( arrayValue => arrayValue==value ),
                        allElementsAreNumbers: array.every( arrayValue=>typeof arrayValue == "number" ),
                        someElementsAreNumbers: array.some( arrayValue=>typeof arrayValue == "number" )
                    });
